...
<html>
	...
	<body>	
		<div id="navbar" style='position:fixed;'>
			<div id='icon'>LandAsia Bus Service<br><p style='font-size:12px;margin-top:-2px;margin-left:180px;'>SAFE, TRUSTWORTHY & HONEST</p></div>
		...
		<form action="buy_seat.php" name="seats" method="POST">	
			<div id="all" style='margin-top:20px;'>
				...
				<?php
					mysql_connect("localhost","shin","123456","bus_ticket_web");
					mysql_select_db('bus_ticket_web');
